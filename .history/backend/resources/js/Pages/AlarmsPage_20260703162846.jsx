...
const SEVERITY_STYLE = {
  CRITICAL: { bg: '#3a1010', color: '#f87171', border: '#7f1d1d' },
  WARNING:  { bg: '#3a200a', color: '#fbbf24', border: '#78350f' },
  INFO:     { bg: '#10203e', color: '#60a5fa', border: '#1e3a8a' },
};
...
const styles = {
  ...
  tab:           { padding: '6px 16px', borderRadius: 6, border: '1px solid #183350', background: '#102a43', cursor: 'pointer', fontSize: 13, color: '#bcccdc', fontFamily: 'Montserrat, sans-serif' },
  tabActive:     { background: '#159ed5', color: '#fff', border: '1px solid #159ed5' },
  empty:         { textAlign: 'center', padding: 60, color: '#bcccdc', fontSize: 15 },
  ...
  timestamps:    { color: '#bcccdc', fontSize: 11 },
