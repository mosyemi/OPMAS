...
const styles = {
  shell:     { minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0c1a30', fontFamily: 'Montserrat, sans-serif' },
  card:      { background: '#102a43', borderRadius: 14, padding: '40px 36px', width: 360, boxShadow: '0 4px 24px rgba(0,0,0,0.3)', border: '1px solid #183350' },
  ...
  logoSub:   { fontSize: 12, color: '#bcccdc', marginTop: 4 },
  ...
  input:     { display: 'block', width: '100%', padding: '10px 14px', borderRadius: 6, border: '1px solid #183350', background: '#0c1a30', color: '#f8fafc', marginBottom: 12, fontSize: 14, boxSizing: 'border-box', fontFamily: 'Montserrat, sans-serif' },
  ...
  note:      { textAlign: 'center', fontSize: 11, color: '#bcccdc' },
};