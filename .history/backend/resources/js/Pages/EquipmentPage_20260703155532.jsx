...
const styles = {
  title:       { color: '#f8fafc', marginBottom: 20, fontSize: 22, fontWeight: 'bold' },
  grid:        { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 },
  card:        { background: '#1e293b', borderRadius: 10, padding: 20, border: '1px solid #334155', boxShadow: '0 4px 12px rgba(0,0,0,0.15)' },
  ...
  code:        { color: '#94a3b8', fontSize: 12 },
  statusBadge: { background: '#14532d', color: '#4ade80', padding: '3px 10px', borderRadius: 99, fontSize: 10, fontWeight: 'bold' },
  meta:        { fontSize: 12, color: '#94a3b8', display: 'flex', flexDirection: 'column', gap: 4 },
  date:        { color: '#cbd5e1' },
  highlightDate: { color: '#3b82f6' },
};