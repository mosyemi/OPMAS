...
const styles = {
  shell:    { display: 'flex', minHeight: '100vh', background: '#0c1a30', fontFamily: 'Montserrat, sans-serif' }, // Deeper Navy background
  sidebar:  { width: 220, background: '#102a43', display: 'flex', flexDirection: 'column', flexShrink: 0, borderRight: '1px solid #183350' }, // Kijabe Navy
  logo:     { display: 'flex', alignItems: 'center', gap: 10, padding: '24px 16px', borderBottom: '1px solid #183350' },
  logoIcon: { background: '#159ed5', color: '#ffffff', fontWeight: 'bold', fontSize: 18, width: 40, height: 40, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }, // Kijabe Sky Blue
  ...
  main:     { flex: 1, display: 'flex', flexDirection: 'column', overflow: 'auto', background: '#0c1a30' },
