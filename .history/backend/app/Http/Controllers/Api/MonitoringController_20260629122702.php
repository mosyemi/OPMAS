...
class MonitoringController extends Controller
{
    ...
    public function equipment()
    {
        return response()->json([
            'equipment' => [
                ['id' => 1, 'name' => 'Oxygen Generator', 'status' => 'running', 'zone' => 'Plant A'],
                ['id' => 2, 'name' => 'Compressor Unit', 'status' => 'idle', 'zone' => 'Plant A'],
                ['id' => 3, 'name' => 'Buffer Tank', 'status' => 'normal', 'zone' => 'Plant B'],
            ],
        ]);
    }
