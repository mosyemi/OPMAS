...
const styles = {
  page:          { color: '#102a43', fontFamily: 'Montserrat, sans-serif' },
  header:        { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 },
  title:         { margin: 0, color: '#102a43', fontSize: 22, fontWeight: 'bold' },
  activeCount:   { margin: '4px 0 0', color: '#ef4444', fontSize: 13, fontWeight: 'bold' },
  tabs:          { display: 'flex', gap: 8 },
  tab:           { padding: '6px 16px', borderRadius: 6, border: '1px solid #e2e8f0', background: '#ffffff', cursor: 'pointer', fontSize: 13, color: '#486581', fontFamily: 'Montserrat, sans-serif' },
  tabActive:     { background: '#159ed5', color: '#fff', border: '1px solid #159ed5' },
  empty:         { textAlign: 'center', padding: 60, color: '#627d98', fontSize: 15 },
  ...
  type:          { fontWeight: 'bold', color: '#102a43', fontSize: 14 },
  resolvedBadge: { background: '#dcfce7', color: '#166534', fontSize: 10, padding: '2px 8px', borderRadius: 99, fontWeight: 'bold' },
  message:       { margin: '0 0 6px', color: '#334e68', fontSize: 13 },
  timestamps:    { color: '#627d98', fontSize: 11 },
  resolveBtn:    { padding: '6px 16px', background: '#159ed5', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 13, fontWeight: 'bold', whiteSpace: 'nowrap', fontFamily: 'Montserrat, sans-serif' },
};