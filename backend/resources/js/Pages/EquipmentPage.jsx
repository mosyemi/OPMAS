  ...
  return (
    <div>
      ...
      <div style={styles.grid}>
        {list.map(eq => (
          /* Added hover-card class for the mouse-hover lift effect */
          <div key={eq.code} className="hover-card" style={styles.card}>
...
const styles = {
  ...
  // Green status badge style restored
  statusBadge: { background: '#dcfce7', color: '#166534', padding: '3px 10px', borderRadius: 99, fontSize: 11, fontWeight: 'bold' },
